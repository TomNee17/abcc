...
namespace Entity_Framework_Code_First {
    ...
    public partial class QLSV1DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string name, string email, string phoneNumber, string image) {
...
namespace Entity_Framework_Code_First.QLSV1DataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([studentID] = @Original_studentID) AND ((@Is" +
                "Null_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_im" +
                "age = 1 AND [image] IS NULL) OR ([image] = @Original_image)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([name], [email], [phoneNumber], [image]) VALUES (@n" +
                "ame, @email, @phoneNumber, @image);\r\nSELECT studentID, name, email, phoneNumber," +
                " image FROM Students WHERE (studentID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [name] = @name, [email] = @email, [phoneNumber] = @phoneNumber, [image] = @image WHERE (([studentID] = @Original_studentID) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_image = 1 AND [image] IS NULL) OR ([image] = @Original_image)));
SELECT studentID, name, email, phoneNumber, image FROM Students WHERE (studentID = @studentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Entity_Framework_Code_First.Properties.Settings.Default.QLSV1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT studentID, name, email, phoneNumber, image FROM dbo.Students";
        ...
        public virtual int Fill(QLSV1DataSet.StudentsDataTable dataTable) {
        ...
        public virtual QLSV1DataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLSV1DataSet.StudentsDataTable dataTable = new QLSV1DataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLSV1DataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_studentID, string Original_name, string Original_image) {
        ...
        public virtual int Insert(string name, string email, string phoneNumber, string image) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string email, string phoneNumber, string image, int Original_studentID, string Original_name, string Original_image, int studentID) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string email, string phoneNumber, string image, int Original_studentID, string Original_name, string Original_image) {
            return this.Update(name, email, phoneNumber, image, Original_studentID, Original_name, Original_image, Original_studentID);
        }
    }
